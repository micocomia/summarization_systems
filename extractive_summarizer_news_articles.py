...
# Main Function
def main():
    model_path = "C:/Users/karel/OneDrive/Documents/Data science application/beert_summarizer.pth"
    df = pd.read_csv("C:/Users/karel/OneDrive/Documents/Data science application/cleaned_data.csv").reset_index(drop=True)
    ...
    train_dataset = NewsSummarizationDataset(train_articles, train_summaries, tokenizer, model_instance)
    val_dataset = NewsSummarizationDataset(val_articles, val_summaries, tokenizer, model_instance)
