...
class SessionState:
    ...
    def __init__(self):
        ...
        self.settings = {
            "summarization_type": "extractive",  # abstractive or extractive
...
class IntentHandlerManager:
    ...
    def __init__(self, 
                ...
                scientific_extractive_summarizer_class = None,
                document_qa=None):
        """
        ...
        self.extractive_scientific_summarizer = scientific_extractive_summarizer_class
    ...
    def handle_intent(self, intent_type: str, intent_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        intent_handlers = {
            ...
            "Extractive_summarizer_scientific": self._handle_extractive_summarization_scientific,
    ...
    def _handle_extractive_summarization_news(self, intent_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Generate extractive summary for news articles
        try:
            summary_result = self.extractive_news_summarizer.summarize(
                length=summary_length,
                focus_topics=focus_topics if focus_topics else None
            )
    ...
    def _handle_extractive_summarization_scientific(self, intent_data: Dict[str, Any]) -> Dict[str, Any]:
        """Handle extractive summarization intent."""
        if not self.session.documents_loaded:
            return {
                "text": "Please upload some documents first before asking for a summary."
        ...
        # Generate extractive summary for news articles
        try:
            summary_result = self.extractive_scientific_summarizer.summarize(
                length=summary_length,
                focus_topics=focus_topics if focus_topics else None
            )
